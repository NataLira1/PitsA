...
//                	pedidoRepository.deleteById(1L);
                 ...
                 * )
                 * void quandoEstabelecimentoBuscaPedidoDeOutroEstabelecimento() throws
                 * Exception {
                 * // Arrange
                 * pedidoRepository.save(pedido);
                 ...
                 * )
                 * void quandoEstabelecimentoExcluiPedidoDeOutroEstabelecimento() throws
                 * Exception {
                 * // Arrange
                 * pedidoRepository.save(pedido);
                 * Estabelecimento estabelecimento1 =
                 ...
                 * )
                 * void quandoClienteBuscaPedidoFeitoEmEstabelecimentoInexistente() throws
                 * Exception {
                 * // Arrange
                 * pedidoRepository.save(pedido);
                 * 
                 ...
                 * )
                 * void quandoClienteBuscaPedidoFeitoEmEstabelecimentoComPedidoInexistente()
                 * throws Exception {
                 * // Arrange
                 * pedidoRepository.save(pedido);
                 * 
                 ...
                 * )
                 * void quandoClienteBuscaPedidoFeitoEmEstabelecimentoComClienteInexistente()
                 * throws Exception {
                 * // Arrange
                 * pedidoRepository.save(pedido);
                 * 
                 ...
                 * )
                 * void
                 * quandoClienteBuscaTodosPedidosFeitosNaqueleEstabelecimentoComPedidoIdNull()
                 * throws Exception {
                 * // Arrange
                 * pedidoRepository.save(pedido);
                 * 
